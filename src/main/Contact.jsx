...
<section class=" text-gray-800 bg-slate-200 py-4 ">
    ...
    <div class="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
      <form>
        ...
        <div class="form-group form-check text-center mb-6">
          <input type="checkbox"
            class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-white checked:white focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
        ...
        rounded
        shadow-md
        hover:[#2E8B57] hover:shadow-lg
        focus:bg-[#2E8B57] focus:shadow-lg focus:outline-none focus:ring-0
        active:bg-[#2E8B57] active:shadow-lg
        transition
        duration-150
